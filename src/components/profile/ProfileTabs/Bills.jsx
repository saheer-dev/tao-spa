...
export default function Bills() {
  ...
  <>
            ...
            <div className="flex justify-around px-6 py-1 text-[16px] font-[600]">
              ...
              <div className="w-[15%]">Bill ID </div>
              ...
              <div className="w-[1%]"> </div>
...

                {
                  ...
                  <div className="w-[20%] text-[14px]">{bill.Therapist}</div>
                  <div className="w-[15%] text-[14px]">{bill.BillID}</div>
                  <div className="w-[15%] text-[14px]">{bill.Treatment}</div>
                  <div className="w-[15%] text-[14px]">{bill.Time}</div>
                  <div className="w-[15%] text-[14px]">{bill.Date}</div>
                  <div className="w-[15%] text-[14px]">{bill.Amount}</div>
                  <div className="w-[15%] text-[14px]">
                    <button className={bill.Status=='Unpaid'?"bg-[rgba(241,30,30,0.12)] w-fit px-3 py-1  rounded-full text-[#F11E1E]":"bg-[rgba(0,128,0,0.12)] w-fit px-3 py-1  rounded-full text-[#008000]"}>{bill.Status}</button>
                  </div>
