  ...
  return (
    <div className=" mt-4 gap-4" id="ongoingGrid">
      <div className="bg-white border-[1px] h-fit rounded-[5px] border-[#CECECE] p-3">
        ...
        <div>
          <h1 className="flex items-center gap-1   text-[14px] text-[#2E782E] font-[600]">
            <svg
            ...
            >
              <path
                d="M9.64821 0.94043L4.15306 6.43557L1.65527 3.93778"
                stroke="#2E782E"
                stroke-width="1.33216"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
            </svg>{" "}
            25 of 25 - Appointment Completed
          </h1>
          <div className="bg-[#37A437] rounded-full w-full h-[6px] mt-2 mb-3">
          ...
          <h1 className="text-[13px] my-3 text-[#008000]  font-[600]">
            ₹25,000 Paid
          </h1>
          <button
            onClick={() => setTreatmenttab(4)}
