...
export default function Track_ongoing() {
  ...
  return (
    <div>
      <button className="px-2 mt-3" onClick={() => setTreatmenttab(1)}>
        <svg
      ...
      <div className="flex items-center justify-between mt-2 mb-4 text-[#333]">
        ...
        <div className="flex flex-col items-end gap-1 justify-between">
          ...
          <h1 className="text-[12px] w-fit font-[600] px-2 py-[6px] rounded-[10px] bg-[#F5F5FF] text-[#00F]">
              ...
              <button
                className={
                  bill.Status == "Completed"
                    ...
                    ? "bg-[#FFEECF] w-fit px-3 py-1  rounded-full text-[#FF5C00]"
      ...
      <div className="flex items-center justify-between mt-4">
        {/* <button className="p-2" onClick={() => setTreatmenttab(1)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
