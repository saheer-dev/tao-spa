...
export default function Booking_Step1() {
  ...
  return (
    <>
      ...
      <div className="font-[600] h-[350px] relative py-5">
        <form action="">
          <h1 className="text-[#BB760B] text-[16px]">Enter Details</h1>
          ...
          <div className="flex w-full gap-6">
            <div className="mt-2 w-[30%]">
              ...
              <div className="flex self-end w-full justify-end">
                <div className=" text-[14px] font-[400] flex items-center justify-center cursor-pointer w-[74px] bg-[#999] rounded-[4px] text-white mt-1 ">
                  Verify
                </div>
              </div>
            </div>
            ...
            <div className="mt-2 w-[30%]">
              ...
              <div className="flex self-end w-full justify-start">
                <div className=" text-[12px] font-[400]  rounded-[4px] text-[#939393] mt-1 ">
        ...
        <div className="flex items-end justify-end h-fit absolute right-0 bottom-3 gap-3  ">
          {/* <button
            ...
            className="border-[1px] border-[#999] text-[#999] bg= text-[18px] px-5 py-[6px] rounded-full flex gap-2 items-center "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="8"
